"""
Centralized logging configuration for the Bookshelf Demo processor.

This module provides a consistent, configurable logging setup used
throughout the processor pipeline. All modules should use get_logger()
...
- Log files are written to the processor directory
"""
...
# Log file path (in the processor directory)
LOG_FILE = Path(__file__).parent / "processor.log"
...
def _setup_root_logger():
    ...
    infrastructure for the entire processor.
    """
